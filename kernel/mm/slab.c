...
const struct command slab_debug = SUBMENU("&slab",
	CMD("&dump slabs", dump_slabs, (void *)-1),
	CMD("dump slab &counts",      dump_slab_counts, (void *)-1),
	CMD("dump &wasted bytes",     dump_wasted_bytes, (void *)-1),
	JOB("&loop dump slab counts", dump_slab_counts_loop, NULL),
	CMD("allocate 8",             alloc,   (void *)8 ),
	CMD("allocate 16",            alloc,   (void *)16 ),
	CMD("allocate 32",            alloc,   (void *)32 ),
	CMD("free 32",                free,    (void *)32 ),
	CMD("free 32rev",             freerev, (void *)32 ),
	CMD("leak 128x32",            leak128, (void *)32 ),
	CMD("allocate 64",            alloc,   (void *)64 ),
	CMD("allocate 128",           alloc,   (void *)128 ),
	CMD("allocate 256",           alloc,   (void *)256 ),
	CMD("allocate 512",           alloc,   (void *)512 ),
	CMD("allocate 1024",          alloc,   (void *)1024 ),
	CMD("allocate 2048",          alloc,   (void *)2048 ),
	CMD("allocate 4096",          alloc,   (void *)4096 ),
);
